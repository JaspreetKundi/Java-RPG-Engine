...
public class FreindlyNPC {
  ...
  public void FreindlyNPC(GamePanel gp) {
  ...
  public void update(GamePanel gp) {
    ...
    gp.cChecker.checkTileFreindNPC(this);// Checks the tiles with the boss in collision, to make sure if the boss is
